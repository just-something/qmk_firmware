...
[0] = LAYOUT_ansi_84(
	...
	LM(5,MOD_LSFT),					KC_Z,   		KC_X,   	KC_C,  		KC_V,   	KC_B,   	KC_N,   	KC_M,   	KC_COMM,		KC_DOT,		KC_SLSH,					LM(5,MOD_LSFT),	KC_UP,		KC_END,
	LM(5,MOD_LCTL),	LM(5,MOD_LALT),	LM(5,MOD_LGUI),										KC_SPC, 							LM(5,MOD_LGUI),	MO(1),   	LM(5,MOD_LCTL),				KC_LEFT,		KC_DOWN,    KC_RGHT),
...
// layer win
[2] = LAYOUT_ansi_84(
	KC_ESC, 		KC_BRID,   		KC_BRIU,    	KC_F3,  	KC_F4,   	KC_F5,   	KC_F6,   	KC_MPRV,   	KC_MPLY,   	KC_MNXT,  		KC_MUTE, 	KC_VOLD, 		KC_VOLU, 	KC_PSCR,		KC_INS,		KC_DEL,
	KC_GRV, 		KC_1,   		KC_2,   		KC_3,  		KC_4,   	KC_5,   	KC_6,   	KC_7,   	KC_8,   	KC_9,  			KC_0,   	KC_MINS,		KC_EQL, 					KC_BSPC,	KC_PGUP,
	KC_TAB, 		KC_Q,   		KC_W,   		KC_E,  		KC_R,   	KC_T,   	KC_Y,   	KC_U,   	KC_I,   	KC_O,  			KC_P,   	KC_LBRC,		KC_RBRC, 					KC_BSLS,	KC_PGDN,
	KC_CAPS,		KC_A,   		KC_S,   		KC_D,  		KC_F,   	KC_G,   	KC_H,   	KC_J,   	KC_K,   	KC_L,  			KC_SCLN,	KC_QUOT, 	 								KC_ENT,		KC_HOME,
	LM(5,MOD_LSFT),					KC_Z,   		KC_X,   	KC_C,  		KC_V,   	KC_B,   	KC_N,   	KC_M,   	KC_COMM,		KC_DOT,		KC_SLSH,					LM(5,MOD_LSFT),	KC_UP,		KC_END,
	LM(5,MOD_LCTL),	LM(5,MOD_LGUI),	LM(5,MOD_LALT),										KC_SPC, 							LM(5,MOD_LALT),	MO(3),   	LM(5,MOD_LCTL),				KC_LEFT,		KC_DOWN,    KC_RGHT),

// layer win Fn
[3] = LAYOUT_ansi_84(
	_______, 	KC_F1,  	KC_F2,  	_______, 	_______,  	_______,  	_______,  	KC_F7,  	KC_F8,  	KC_F9, 		KC_F10, 	KC_F11, 	KC_F12,		_______,	_______,	_______,
	_______, 	LNK_BLE1,  	LNK_BLE2,  	LNK_BLE3,  	LNK_RF,   	_______,   	_______,   	_______,   	_______,   	_______,  	_______,   	_______,	_______, 				_______,	_______,
	_______, 	_______,   	_______,   	_______,  	_______,   	_______,   	_______,   	_______,   	_______,   	_______,  	_______,   	DEV_RESET,	SLEEP_MODE, 			BAT_SHOW,	_______,
	_______,	_______,   	_______,   	_______,  	_______,   	_______,   	_______,	_______,   	_______,   	_______,  	_______,	_______, 	 						_______,	_______,
	_______,				_______,   	_______,   	_______,  	_______,   	_______,   	_______,	MO(4), 		RGB_SPD,	RGB_SPI,	_______,				_______,	RGB_VAI,	_______,
